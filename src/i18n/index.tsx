...
const en = {
  ...
  "ask.subtitle": "Your personal sommelier, grounded in your taste",
  "ask.signIn": "Sign in to ask WineSnap.",
  "ask.new": "New conversation",
  "ask.history": "Conversations",
  "ask.noHistory": "No previous conversations yet.",
  "ask.placeholder": "Ask about a wine, pairing, region, or your cellar…",
  "ask.send": "Send",
  "ask.thinking": "Considering your taste…",
  "ask.contextWine": "Using the current wine as context",
  "ask.contextMemory": "Uses your Wine Memory and cellar when relevant",
  "ask.emptyTitle": "What would you like to know?",
  "ask.emptyDesc": "Ask for a pairing, compare styles, or get help choosing from your cellar.",
  "ask.prompt.pairing": "What in my cellar works with dinner tonight?",
  "ask.prompt.explore": "Which wine region should I explore next?",
  "ask.prompt.taste": "How would you describe my wine taste?",
  "ask.recommendations": "See recommendations",
  "ask.delete": "Delete conversation",
  "ask.deleteConfirm": "Delete this conversation?",
  ...
  "taste.addOwn": "+ Add your own",
  "taste.addRegionPlaceholder": "Region name",
  "taste.addGrapePlaceholder": "Grape name",
  "taste.add": "Add",
  ...
  "overview.marketValue": "Estimated Value",
  "overview.marketValueDesc": "Current retail prices from the Systembolaget catalogue.",
  "overview.marketValueEmpty": "Update values to estimate what your cellar is worth today.",
  "overview.updateValues": "Update values",
  "overview.updating": "Updating…",
  "overview.valuesUpdated": "Values updated",
  "overview.valuesFailed": "Could not update values",
  "overview.vsPurchase": "vs. purchase",
  "overview.valued": "valued",
  "overview.lastChecked": "Last checked",
  ...
  "scan.fieldName": "Wine",
  "scan.fieldVintage": "Vintage",
  "scan.fieldRegion": "Region",
  "scan.fieldGrapes": "Grapes",
  "scan.fieldType": "Type",
  ...
  "notes.summaryPh": "For example: I liked the fruit, but it was a little too sweet…",
  "notes.saveMine": "Save my notes",
  "notes.saveFailed": "Your notes could not be saved. Try again.",
  "notes.loadFailed": "The wine could not be loaded.",
  "notes.historyFailed": "Previous notes could not be loaded.",
  "notes.unsavedConfirm": "You have unsaved changes. Leave without saving?",
  "notes.aromaActive": "Include {name} in my notes",
  "notes.weak": "Subtle",
  "notes.clear": "Pronounced",
  "notes.notSet": "Not set",
  "notes.intensityFor": "Intensity for {name}",
  "notes.chooseIntensity": "Choose intensity",
  "notes.chooseValue": "Choose value",
  "notes.searchAroma": "Search aromas…",
  "notes.noAromaMatch": "No aroma found.",
  "notes.addOwn": "Add “{name}”",
  "notes.compareAi": "Compare with AI suggestions",
  "notes.showWheel": "Show aroma wheel",
  "notes.useAsNew": "Use as new",
  ...
  "recommendation.coldStart":
    "This is an early estimate. Rate wines or update your taste profile to improve it.",
  "recommendation.like": "I like this",
  "recommendation.notForMe": "Not for me",
  "recommendation.feedbackSaved": "Your Wine Memory has been updated.",
  "recommendation.feedbackError": "The feedback could not be saved.",

  // Compare
  "compare.title": "Compare wines",
  "compare.subtitle": "See style differences and how each wine fits your taste.",
  "compare.signIn": "Sign in to compare wines from your cellar.",
  "compare.first": "First wine",
  "compare.second": "Second wine",
  "compare.choose": "Choose a wine",
  "compare.needTwo": "Add at least two wines to your cellar to compare them.",
  "compare.similarity": "style similarity",
  "compare.structure": "Structure",
  "compare.log": "Save comparison",
  "compare.logged": "Comparison saved.",
  "compare.sameWine": "Choose two different wines.",
  "compare.body": "Body",
  "compare.tannin": "Tannin",
  "compare.acidity": "Acidity",
  "compare.sweetness": "Sweetness",
  "compare.oak": "Oak",
  "compare.fruit": "Fruit",
...
const sv: Record<keyof typeof en, string> = {
  ...
  "ask.signIn": "Logga in för att fråga WineSnap.",
  ...
  "ask.contextWine": "Använder det aktuella vinet som kontext",
  "ask.contextMemory": "Använder ditt vinminne och din källare när det är relevant",
  "ask.emptyTitle": "Vad vill du veta?",
  "ask.emptyDesc": "Fråga om matparning, jämför stilar eller få hjälp att välja ur källaren.",
  "ask.prompt.pairing": "Vad i min källare passar till middagen i kväll?",
  "ask.prompt.explore": "Vilken vinregion borde jag utforska härnäst?",
  "ask.prompt.taste": "Hur skulle du beskriva min vinsmak?",
  "ask.recommendations": "Se rekommendationer",
  "ask.delete": "Radera konversation",
  "ask.deleteConfirm": "Radera den här konversationen?",
  ...
  "taste.addOwn": "+ Lägg till egen",
  "taste.addRegionPlaceholder": "Regionens namn",
  "taste.addGrapePlaceholder": "Druvans namn",
  "taste.add": "Lägg till",
  ...
  "overview.marketValue": "Uppskattat värde",
  "overview.marketValueDesc": "Aktuella priser från Systembolagets sortiment.",
  "overview.marketValueEmpty": "Uppdatera värden för att se vad källaren är värd idag.",
  "overview.updateValues": "Uppdatera värden",
  "overview.updating": "Uppdaterar…",
  "overview.valuesUpdated": "Värden uppdaterade",
  "overview.valuesFailed": "Kunde inte uppdatera värden",
  "overview.vsPurchase": "mot inköp",
  "overview.valued": "värderade",
  "overview.lastChecked": "Senast kontrollerat",
  ...
  "scan.save": "Spara",
  "scan.discard": "Kasta",
  "scan.fieldProducer": "Producent",
  "scan.fieldName": "Vin",
  "scan.fieldVintage": "Årgång",
  "scan.fieldRegion": "Region",
  "scan.fieldGrapes": "Druvor",
  "scan.fieldType": "Typ",
  ...
  "notes.summaryPh": "Till exempel: Jag gillade frukten, men det var lite för sött…",
  "notes.saveMine": "Spara mina noter",
  "notes.saveFailed": "Dina noter kunde inte sparas. Försök igen.",
  "notes.loadFailed": "Vinet kunde inte laddas.",
  "notes.historyFailed": "Tidigare noter kunde inte laddas.",
  "notes.unsavedConfirm": "Du har osparade ändringar. Vill du lämna utan att spara?",
  "notes.aromaActive": "Ta med {name} i mina noter",
  "notes.weak": "Svag",
  "notes.clear": "Tydlig",
  "notes.notSet": "Ej vald",
  "notes.intensityFor": "Intensitet för {name}",
  "notes.chooseIntensity": "Välj intensitet",
  "notes.chooseValue": "Välj värde",
  "notes.searchAroma": "Sök aromer…",
  "notes.noAromaMatch": "Ingen arom hittades.",
  "notes.addOwn": "Lägg till ”{name}”",
  "notes.compareAi": "Jämför med AI-förslaget",
  "notes.showWheel": "Visa aromhjul",
  "notes.useAsNew": "Använd som ny",
  ...
  "recommendation.coldStart":
    "Det här är en tidig uppskattning. Betygsätt viner eller uppdatera smakprofilen för bättre träffar.",
  "recommendation.like": "Det här gillar jag",
  "recommendation.notForMe": "Inte för mig",
  "recommendation.feedbackSaved": "Ditt Wine Memory har uppdaterats.",
  "recommendation.feedbackError": "Feedbacken kunde inte sparas.",

  "compare.title": "Jämför viner",
  "compare.subtitle": "Se stilskillnader och hur varje vin passar din smak.",
  "compare.signIn": "Logga in för att jämföra viner i din källare.",
  "compare.first": "Första vinet",
  "compare.second": "Andra vinet",
  "compare.choose": "Välj ett vin",
  "compare.needTwo": "Lägg till minst två viner i källaren för att jämföra dem.",
  "compare.similarity": "stillikhet",
  "compare.structure": "Struktur",
  "compare.log": "Spara jämförelse",
  "compare.logged": "Jämförelsen har sparats.",
  "compare.sameWine": "Välj två olika viner.",
  "compare.body": "Fyllighet",
  "compare.tannin": "Tannin",
  "compare.acidity": "Syra",
  "compare.sweetness": "Sötma",
  "compare.oak": "Ek",
  "compare.fruit": "Frukt",
